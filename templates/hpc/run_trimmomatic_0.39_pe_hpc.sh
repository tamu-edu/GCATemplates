...
######### SYNOPSIS #########
# This script will trim Illumina paired end reads using the Trimmomatic tool
...
######## PARAMETERS ########
install_dir=$EBROOTTRIMMOMATIC    # change this to the full path of the directory containing trimmomatic-0.39.jar
cpus=$SLURM_CPUS_PER_TASK
min_length=30
quality_format='-phred33'       # -phred33, -phred64    # see https://en.wikipedia.org/wiki/FASTQ_format#Encoding 
adapter_file="$install_dir/adapters/TruSeq3-PE.fa"
...
java -jar $install_dir/trimmomatic-0.39.jar \
PE -threads $cpus $quality_format $pe_1 $pe_2 \
